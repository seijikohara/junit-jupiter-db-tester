// Configure test suites with all necessary dependencies for integration tests
testing {
    suites {
        val test by getting(JvmTestSuite::class) {
            dependencies {
                ...
                // Testing frameworks with BOM for version management
