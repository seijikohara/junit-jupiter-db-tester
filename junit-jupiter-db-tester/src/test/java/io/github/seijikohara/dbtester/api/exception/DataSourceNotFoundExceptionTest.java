...
class DataSourceNotFoundExceptionTest {
  ...
  /** Tests for the single-argument constructor DataSourceNotFoundException(String). */
  @Nested
  @DisplayName("DataSourceNotFoundException(String) constructor")
  class SingleArgumentConstructor {
    ...
    void shouldCreateException_withMessage() {
      // Given
      final var message = "data source not found";
    ...
    void shouldThrowException_whenMessageIsNull() {
      ...
      final var exception =
          assertThrows(
              NullPointerException.class, () -> new DataSourceNotFoundException(nullMessage));

      assertEquals("message must not be null", exception.getMessage());
    }
  }

  /** Tests for the two-argument constructor DataSourceNotFoundException(String, Throwable). */
  @Nested
  @DisplayName("DataSourceNotFoundException(String, Throwable) constructor")
  class TwoArgumentConstructor {
    ...
    void shouldThrowException_whenMessageIsNull() {
      ...
      final var exception =
          assertThrows(
              ...
              () -> new DataSourceNotFoundException(nullMessage, cause));
    ...
    void shouldThrowException_whenCauseIsNull() {
      ...
      final var exception =
          assertThrows(
              NullPointerException.class,
              () -> new DataSourceNotFoundException(message, nullCause));

      assertEquals("cause must not be null", exception.getMessage());
    }
  }

  /** Tests for the single-cause constructor DataSourceNotFoundException(Throwable). */
  @Nested
  @DisplayName("DataSourceNotFoundException(Throwable) constructor")
  class SingleCauseConstructor {
    ...
    void shouldThrowException_whenCauseIsNull() {
      ...
      final var exception =
          assertThrows(
              NullPointerException.class, () -> new DataSourceNotFoundException(nullCause));
