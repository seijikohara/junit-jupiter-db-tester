...
class DataSetLoadExceptionTest {
  ...
  /** Tests for the single-argument constructor DataSetLoadException(String). */
  @Nested
  @DisplayName("DataSetLoadException(String) constructor")
  class SingleArgumentConstructor {
    ...
    void shouldThrowException_whenMessageIsNull() {
      ...
      // When & Then
      final var exception =
          assertThrows(NullPointerException.class, () -> new DataSetLoadException(nullMessage));

      assertEquals("message must not be null", exception.getMessage());
    }
  }

  /** Tests for the two-argument constructor DataSetLoadException(String, Throwable). */
  @Nested
  @DisplayName("DataSetLoadException(String, Throwable) constructor")
  class TwoArgumentConstructor {
    ...
    void shouldThrowException_whenMessageIsNull() {
      ...
      final var exception =
          assertThrows(
              NullPointerException.class, () -> new DataSetLoadException(nullMessage, cause));
    ...
    void shouldThrowException_whenCauseIsNull() {
      ...
      final var exception =
          assertThrows(
              NullPointerException.class, () -> new DataSetLoadException(message, nullCause));

      assertEquals("cause must not be null", exception.getMessage());
    }
  }

  /** Tests for the single-cause constructor DataSetLoadException(Throwable). */
  @Nested
  @DisplayName("DataSetLoadException(Throwable) constructor")
  class SingleCauseConstructor {
    ...
    void shouldThrowException_whenCauseIsNull() {
      ...
      // When & Then
      final var exception =
          assertThrows(NullPointerException.class, () -> new DataSetLoadException(nullCause));
