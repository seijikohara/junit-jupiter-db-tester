...
/**
 * Compares two datasets for equality with comprehensive validation.
 *
 * <p>This class performs both structural validation (table names and counts) and content validation
 * (row-by-row comparison) of datasets. It is used internally by {@link DatabaseAssert} to provide
